...
The aim of this work is to show how two simple and lightweight approaches (NEIGHBOURS and DIRECTIONS) are competitive with the well-known Successive Halving algorithm in terms of classification performance, being less processing time-consuming and using less memory (RAM-Hours). 
